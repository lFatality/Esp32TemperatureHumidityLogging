 ...
 */
AdafruitSi7021Driver::AdafruitSi7021Driver(TwoWire *theWire) {
 ...
 * timeout
 */
float AdafruitSi7021Driver::readTemperature() {
  _wire->beginTransmission(_i2caddr);
 ...
 */
void AdafruitSi7021Driver::reset() {
  _wire->beginTransmission(_i2caddr);
...
void AdafruitSi7021Driver::_readRevision(void) {
  _wire->beginTransmission(_i2caddr);
 ...
 */
void AdafruitSi7021Driver::readSerialNumber() {
  _wire->beginTransmission(_i2caddr);
 ...
 *  @return model value
 */
si_sensorType AdafruitSi7021Driver::getModel() { return _model; }

/*******************************************************************/

void AdafruitSi7021Driver::_writeRegister8(uint8_t reg, uint8_t value) {
  _wire->beginTransmission(_i2caddr);
  _wire->write(reg);
  _wire->write(value);
  _wire->endTransmission();
...
uint8_t AdafruitSi7021Driver::_readRegister8(uint8_t reg) {
  uint8_t value;
  _wire->beginTransmission(_i2caddr);
...
uint16_t AdafruitSi7021Driver::_readRegister16(uint8_t reg) {
  uint16_t value;
  _wire->beginTransmission(_i2caddr);
  _wire->write(reg);
